...
A hazai kereskedelmi forgalomban kapható alapanyagokhoz igazodva az alábbi receptúra javasolt:
...
<div style="background: #dde8d8; border-radius: 12px; padding: 24px 28px; margin: 20px 0;">
  <div style="display: flex; align-items: center; gap: 20px; padding: 16px 0;">
    ...
    <p style="margin: 0; text-align: left;"><strong>Aprítás:</strong> Cél a 2-12mm-es szemcseméret. Kerüljük a festett mulcsot és a túl sok fás részt (szíjács).</p>
  </div>
  ...
  <div style="display: flex; align-items: center; gap: 20px; padding: 16px 0;">
    ...
    <p style="margin: 0; text-align: left;"><strong>Rostálás:</strong> A 12mm feletti darabok túl gyorsan kiszáradnak. A 2 mm alatti finom por pedig eltömíti a kaspót, ezt ki kell szitálni.</p>
  </div>
</div>
...
*Pseudomonas* fertőzés: Fekete foltok az ágakon, főleg tavasszal. A túlzott nedvesség és a levegőtlen közeg kedvez a kórokozóknak. A fenyőkéreg-mix éppen ezen betegség megelőzésében segít a legjobb hatásfokkal.
