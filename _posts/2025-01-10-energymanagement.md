...
- Tavasz: A fa a tartalékaiból (pl. 100 egységből) indul, és a rügyfakadáskor jelentős energiát költ el (akár 70 egységre is leeshet a szint), mivel az új levelek még nem termelnek, csak fogyasztanak.<br>
...
<div style="display: flex; gap: 20px; margin: 20px 0; justify-content: center; flex-wrap: wrap;">
  <figure style="flex: 1; min-width: 300px; text-align: center; margin: 0;">
    <img src="/assets/blog/260111_energy1.jpg" alt="Leírás 1" style="width: 100%; height: 400px; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
    <figcaption style="margin-top: 10px; font-style: italic; color: #666;">Természetes növekedés</figcaption>
  </figure>
  <figure style="flex: 1; min-width: 300px; text-align: center; margin: 0;">
    <img src="/assets/blog/260111_energy2.jpg" alt="Leírás 2" style="width: 100%; height: 400px; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
    <figcaption style="margin-top: 10px; font-style: italic; color: #666;">Bonsai harmónia</figcaption>
  </figure>
</div>
