---
layout: post
title: 8 Japanese maple varieties you can grow into perfect bonsai
subtitle:
date: 2026-01-17
categories:
- Observations
...
<figure style="text-align: center; margin: 20px 0;">
  <img src="/assets/blog/260116_jmbonsai_1.jpg" alt="Description" style="width: 100%; max-width: 800px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
  <figcaption style="margin-top: 10px; font-style: italic; color: #666;">Leaves of various *Acer palmatum* varieties</figcaption>
</figure>
...
Beyond those listed, the following varieties are also frequently encountered as bonsai — without any claim to completeness: *"Atropurpureum", "Asahi zuru", "Koto hime", "Kuro hime", "Mikawa yatsufusa", "Nomura", "Sango kaku", "Chishio", "Shin de shōjō", "Sharp's Pygmy", "Kashima", "Beni chidori"*.
...
**Related articles:**
- [The 8 most common bonsai styles](/posts/style2/) - In what styles can you develop these varieties